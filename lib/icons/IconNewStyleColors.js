...
var IconNewStyleColors = function IconNewStyleColors(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('path', { fill: '#8c68b8', d: 'M9.65 3.826H3.854v5.796H9.65V3.826z' }),
    _react2.default.createElement('path', { fill: '#6167d5', d: 'M3.854 13.155H9.65v5.796H3.854z' }),
    _react2.default.createElement('path', { fill: '#44c1f5', d: 'M13.077 3.826h5.796v5.796h-5.796z' }),
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('circle', { fill: '#fff', cx: 14.397, cy: 14.786, r: 0.974 }),
      _react2.default.createElement('path', { fill: '#fff', d: 'M12.518 19.633l3.728-3.897 1.677 1.854.506-.508 2.547 2.551z' })
    )
  );
};

exports.default = IconNewStyleColors;