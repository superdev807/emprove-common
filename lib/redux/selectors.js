...
var postSelector = _fp["default"].get('post.post'); // device
...
var translationsStatusSelector = _fp["default"].get('globalStatus.translationsStatus'); // pdf status
...
var exportInProcessStatusSelector = (0, _reselect.createSelector)(exportStatusSelector, function (exportStatus) {
  return exportStatus === _request.API_PENDING;
});
exports.exportInProcessStatusSelector = exportInProcessStatusSelector;