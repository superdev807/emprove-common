...
exports["default"] = exports.exportContractPdf = exports.sendBidPdf = exports.downloadBidPdf = exports.exportBidPdf = exports.exportRfpSummaryPdf = exports.sendRfpPdf = exports.downloadRfpPdf = exports.exportRfpPdf = void 0;
...
}), _defineProperty(_handleActions, (0, _request.requestPending)(_constants.EXPORT_BID_PDF), function (state, _ref13) {
  var payload = _ref13.payload;
  return _objectSpread({}, state, {
    status: _request.API_PENDING
  });
}), _defineProperty(_handleActions, (0, _request.requestSuccess)(_constants.EXPORT_BID_PDF), function (state, _ref14) {
  var payload = _ref14.payload;
  return _objectSpread({}, state, {
    status: _request.API_SUCCESS
  });
}), _defineProperty(_handleActions, (0, _request.requestFail)(_constants.EXPORT_BID_PDF), function (state, _ref15) {
  var payload = _ref15.payload;
  return _objectSpread({}, state, {
    status: _request.API_FAIL
  });
}), _defineProperty(_handleActions, (0, _request.requestPending)(_constants.DOWNLOAD_BID_PDF), function (state, _ref16) {
  var payload = _ref16.payload;
  return _objectSpread({}, state, {
    status: _request.API_PENDING
  });
}), _defineProperty(_handleActions, (0, _request.requestSuccess)(_constants.DOWNLOAD_BID_PDF), function (state, _ref17) {
  var payload = _ref17.payload;
  return _objectSpread({}, state, {
    status: _request.API_SUCCESS
  });
}), _defineProperty(_handleActions, (0, _request.requestFail)(_constants.DOWNLOAD_BID_PDF), function (state, _ref18) {
  var payload = _ref18.payload;
  return _objectSpread({}, state, {
    status: _request.API_FAIL
  });
}), _defineProperty(_handleActions, (0, _request.requestPending)(_constants.SEND_BID_PDF), function (state, _ref19) {
  var payload = _ref19.payload;
  return _objectSpread({}, state, {
    sendStatus: _request.API_PENDING
  });
}), _defineProperty(_handleActions, (0, _request.requestSuccess)(_constants.SEND_BID_PDF), function (state, _ref20) {
  var payload = _ref20.payload;
  return _objectSpread({}, state, {
    sendStatus: _request.API_SUCCESS
  });
}), _defineProperty(_handleActions, (0, _request.requestFail)(_constants.SEND_BID_PDF), function (state, _ref21) {
  var payload = _ref21.payload;
  return _objectSpread({}, state, {
    sendStatus: _request.API_FAIL
  });
}), _defineProperty(_handleActions, (0, _request.requestPending)(_constants.EXPORT_CONTRACT_PDF), function (state, _ref22) {
  var payload = _ref22.payload;
  return _objectSpread({}, state, {
    status: _request.API_PENDING
  });
}), _defineProperty(_handleActions, (0, _request.requestSuccess)(_constants.EXPORT_CONTRACT_PDF), function (state, _ref23) {
  var payload = _ref23.payload;
  return _objectSpread({}, state, {
    status: _request.API_SUCCESS
  });
}), _defineProperty(_handleActions, (0, _request.requestFail)(_constants.EXPORT_CONTRACT_PDF), function (state, _ref24) {
