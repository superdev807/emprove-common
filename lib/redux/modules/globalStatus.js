...
exports.default = exports.listTranslations = exports.toggleDrawer = exports.setSnackbar = exports.resetSnackbar = void 0;
...
}), _defineProperty(_handleActions, (0, _request.requestPending)(_constants.LIST_TRANSLATIONS), function (state, _ref4) {
  var payload = _ref4.payload;
  return _objectSpread({}, state, {
    translationsStatus: _request.API_PENDING
  });
}), _defineProperty(_handleActions, (0, _request.requestSuccess)(_constants.LIST_TRANSLATIONS), function (state, _ref5) {
  var payload = _ref5.payload;
  return _objectSpread({}, state, {
    translations: payload,
    translationsStatus: _request.API_SUCCESS
  });
}), _defineProperty(_handleActions, (0, _request.requestFail)(_constants.LIST_TRANSLATIONS), function (state, _ref6) {
