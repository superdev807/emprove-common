...
var _partnerFunctions = require("../utils/partnerFunctions");
    ...
    function (_Component) {
      ...
      function PDFExportWrapper() {
        ...
        _defineProperty(_assertThisInitialized(_this), "handleExportRfp", function () {
          ...
          var hostPartner = (0, _partnerFunctions.getPartnerFromHost)();
          var accountPartner = (0, _get["default"])(_this.props.user, 'partner');
          exportRfpPdf({
            id: rfpId,
            params: {
      ...
      _createClass(PDFExportWrapper, [{
        ...
        value: function render() {
          var _this$props7 = this.props,
              ...
              others = _objectWithoutProperties(_this$props7, ["exportStatus", "user"]);
