...
var _default = function _default(timezoneSelector, accountSelector) {
      ...
      function PDFExportWrapper() {
        ...
        _defineProperty(_assertThisInitialized(_this), "handleExportRfp", function () {
          ...
          exportRfpPdf({
            id: rfpId,
            params: {
              timezone: (0, _timeFunctions.getLocalTimezone)() // hostPartner
        ...
        _defineProperty(_assertThisInitialized(_this), "handleViewBidBrief", function (viewBidId, callback, onClose) {
          var bidId = viewBidId || _this.props.match.params.bidId;
          var activationCode = (0, _get["default"])((0, _pureFunctions.parseQueryString)(_this.props.location.search), 'activationCode') || '';

          _this.props.exportBidPdf({
            id: bidId,
            params: {
          ...
          _this.props.exportRfpSummaryPdf({
            ...
            success: function success(_ref5) {
              ...
              _this.props.showModal('pdfViewerModal', {
                ...
                rfpId: rfpId,
                timezone: _this.props.timezone,
                email: (0, _get["default"])(_this.props.user, 'email')
              });
      ...
      _createClass(PDFExportWrapper, [{
        ...
        value: function render() {
          var _this$props6 = this.props,
              exportStatus = _this$props6.exportStatus,
              others = _objectWithoutProperties(_this$props6, ["exportStatus"]);
