...
var withPosts = function withPosts(_ref) {
  ...
  return function (WrappedComponent) {
    ...
    _defineProperty(PostWrapper, "propTypes", {
      ...
      isSinglePost: _propTypes["default"].bool,
      getBlogPosts: _propTypes["default"].func.isRequired,
      getPostBySlug: _propTypes["default"].func.isRequired
    });

    var selector = (0, _reselect.createStructuredSelector)({
      post: _selectors.postSelector,
      postLoading: _selectors.postsLoadingSelector,
      posts: _selectors.postsSelector,
      postsLoading: _selectors.postsLoadingSelector
    });
    var actions = {
