...
var generalContractor = {
  ...
  body: ['The contractor ultimately responsible to the homeowner for the successful completion of larger projects.  They are typically responsible to provide all material, tools, equipment, labor, site activity coordination, and supervision necessary to complete the project.', 'General Contractors often hire Subcontractors to perform specific components of the work.'],
  terms: []
};
...
var MILESTONE_BASED_PAYMENT = {
  ...
  body: ['Sets out various work completion milestones, that once reached, entitles the contractor to payment of an associated pre-determined amount.  Homeowner then makes payment per the Payment Term.'],
  terms: [],
  images: []
};
...
var MONTHLY_PAYMENT = {
  ...
  body: ['Where the contractor submits a monthly invoice for the work it performed during each month. Homeowner then makes payment per the Payment Term. '],
  terms: [],
  images: []
};
...
var BI_WEEKLY_PAYMENT = {
  ...
  body: ['Where the contractor submits an invoice for the work it performed during each 2-week time period. Homeowner then makes payment per the Payment Term.'],
  terms: [],
  images: []
};
