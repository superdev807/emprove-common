...
var CONTINGENCY = {
  title: 'Contingency',
  hasMarkdown: true,
  body: ['A budgeted allowance calculated to cover the cost of items or work which are not known at the time of the cost estimate but which, statistically, might occur.', 'In the case of a [Lump Sum Agreement](/info-center/definitions/lump-sum-agreement), contingency is generally not included in the contractor’s price, rather is held aside by the homeowner in addition to the contractor’s price.'],
  terms: []
};
...
var OVERHEAD_PROFIT = {
  ...
  extraParagraph: ["Emprove's proprietary data engine includes Subcontractor Overhead & Profit in its provision for Material & Labor Costs.  General Contractor Overhead & Profit are provided for separately in the Project Cost Estimate."]
};
