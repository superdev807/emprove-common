...
exports.DateMMYYMask = exports.PhoneNumberMask = exports.NumberMask = void 0;
...
var DateMMYYMask = function DateMMYYMask(_ref3) {
  var inputRef = _ref3.inputRef,
      inputProps = _objectWithoutProperties(_ref3, ["inputRef"]);

  var getMask = function getMask(value) {
  ...
  return _react["default"].createElement(_reactTextMask["default"], _extends({}, inputProps, {
    mask: getMask // eslint-disable-next-line no-extra-boolean-cast
    ,
    showMask: !Boolean(inputProps.placeholder) //placeholder doesn't show if showMask is true
...
exports.DateMMYYMask = DateMMYYMask;