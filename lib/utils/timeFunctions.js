...
exports.getMaximumWeek = exports.getMinimumWeek = exports.awardDateFromRfpSentDueDate = exports.calculateProjectTimeline = exports.strToDate = exports.utcDateWithZeroTime = exports.localDateToUTC = exports.formatUtcDate = exports.strToday = undefined;
...
var utcDateWithZeroTime = exports.utcDateWithZeroTime = function utcDateWithZeroTime(date) {
  if (date) {
    var dateOnly = date instanceof _moment2.default ? date.format('MM/DD/YYYY') : date;
