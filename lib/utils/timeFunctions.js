...
var calculateTimelineFromSubmitProposalsDueDate = exports.calculateTimelineFromSubmitProposalsDueDate = function calculateTimelineFromSubmitProposalsDueDate(submitProposalsDueDate, businessDays) {
...
var toISODateStr = exports.toISODateStr = function toISODateStr(date, timezone) {
  return date ? timezone ? (0, _momentTimezone2.default)(date).tz(timezone).format(dateFormat) : (0, _moment2.default)(date).format(dateFormat) : date;
};