...
exports.getTimezone = exports.getMaximumWeek = exports.getMinimumWeek = exports.awardDateFromRfpSentDueDate = exports.calculateProjectTimeline = exports.calculateTimelineForFinalBidDueDate = exports.calculateTimelineForSiteVisitDueDate = exports.calculateTimelineForSubmitProposalsDueDate = exports.strToDate = exports.utcDateWithZeroTime = exports.localDateToUTC = exports.formatUtcDate = exports.strToday = exports.convertDateFormat = undefined;
...
var calculateTimelineForSubmitProposalsDueDate = exports.calculateTimelineForSubmitProposalsDueDate = function calculateTimelineForSubmitProposalsDueDate(submitProposalsDueDate, businessDays) {
  var businessDaysToUse = process.env.IN_TEST_MODE === 'true' ? 'qa_business_days' : 'md_project_business_days';

  submitProposalsDueDate = (0, _momentBusinessDays2.default)(submitProposalsDueDate).businessAdd(businessDays && businessDays > 0 ? businessDays : 0);
...
var calculateTimelineForSiteVisitDueDate = exports.calculateTimelineForSiteVisitDueDate = function calculateTimelineForSiteVisitDueDate(siteVisitDueDate, businessDays) {
  var businessDaysToUse = process.env.IN_TEST_MODE === 'true' ? 'qa_business_days' : 'md_project_business_days';
...
var calculateTimelineForFinalBidDueDate = exports.calculateTimelineForFinalBidDueDate = function calculateTimelineForFinalBidDueDate(finalBidDueDate, businessDays) {
  var businessDaysToUse = process.env.IN_TEST_MODE === 'true' ? 'qa_business_days' : 'md_project_business_days';
