...
exports.truncateToCentsWithoutRounding = exports.decodeSpecialCharacters = exports.propsChanged = exports.jsonToQueryString = exports.parseQueryString = exports.bindCallbackToPromise = exports.formatAddress = exports.secureWebsiteUrl = exports.sanitizeWebsiteUrl = exports.sanitizeFields = exports.capitalize = void 0;
  ...
  if (deepCompare) {
    ...
    try {
      for (var _iterator = propKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var key = _step.value;
        if (!(0, _isEqual["default"])(_fp["default"].get(key)(props), _fp["default"].get(key)(nextProps))) return true;
      }
    } catch (err) {
...
var truncateToCentsWithoutRounding = function truncateToCentsWithoutRounding(number) {
  return parseFloat(parseFloat(number).toFixed(2)); //toFixed becomes a string
};

exports.truncateToCentsWithoutRounding = truncateToCentsWithoutRounding;