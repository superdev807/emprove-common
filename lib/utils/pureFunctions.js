...
exports.propsChanged = exports.jsonToQueryString = exports.parseQueryString = exports.bindCallbackToPromise = exports.formatAddress = exports.getParameterByNameFormUrl = exports.secureWebsiteUrl = exports.sanitizeWebsiteUrl = exports.sanitizeFields = exports.capitalize = undefined;
...
var getParameterByNameFormUrl = exports.getParameterByNameFormUrl = function getParameterByNameFormUrl(name, url) {
  name = name.replace(/[\[\]]/g, '\\$&');
  ...
  if (deepCompare) {
    ...
    try {
      for (var _iterator = propKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (!isEqual(_fp2.default.get(key)(props), _fp2.default.get(key)(nextProps))) return true;
      }
    } catch (err) {
