...
var _IconHomeAreaAll = _interopRequireDefault(require("../../icons/IconHomeAreaAll"));
...
function (_Component) {
  ...
  _createClass(HomeAreaIcon, [{
    ...
    value: function render() {
      ...
      if (homeAreaId == _enums.HomeArea.ALL) {
        return _react["default"].createElement(_IconHomeAreaAll["default"], otherProps);
      }
