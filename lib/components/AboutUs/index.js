    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_DreamItPartial2.default, { domain: domain, onStep: this.state.sectionIndex >= SectionIndex.DREAM_IT, actionText: actionText, action: function action() {
              return null || _this2.handleStart;
            } }),
          _react2.default.createElement('div', { id: 'tab1', style: { height: '20vh' } }),
          _react2.default.createElement(_CostItPartial2.default, { domain: domain, onStep: this.state.sectionIndex >= SectionIndex.COST_IT, actionText: actionText, action: function action() {
              return null || _this2.handleStart;
            } }),
          _react2.default.createElement('div', { style: { height: '13vh' } }),
          _react2.default.createElement('div', { id: 'tab2', style: { height: '20vh' } }),
          _react2.default.createElement(_BidItPartial2.default, { domain: domain, onStep: this.state.sectionIndex >= SectionIndex.BID_IT, actionText: actionText, action: function action() {
              return null || _this2.handleStart;
            } })
        ),
        _react2.default.createElement(
