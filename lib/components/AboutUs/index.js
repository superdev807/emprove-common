...
var AboutUs = function (_Component) {
  ...
  function AboutUs(props) {
    ...
    _this.handleStart = function () {
      _this.props.history.push('/browse');
    };

    _this.handleProStart = function () {
      _this.props.history.push('/pro');
    };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_DreamItPartial2.default, { domain: domain, onStep: this.state.sectionIndex >= SectionIndex.DREAM_IT, actionText: actionText, action: this.handleStart }),
          _react2.default.createElement('div', { id: 'tab1', style: { height: '20vh' } }),
          _react2.default.createElement(_CostItPartial2.default, { domain: domain, onStep: this.state.sectionIndex >= SectionIndex.COST_IT, actionText: actionText, action: this.handleStart }),
          _react2.default.createElement('div', { style: { height: '13vh' } }),
          _react2.default.createElement('div', { id: 'tab2', style: { height: '20vh' } }),
          _react2.default.createElement(_BidItPartial2.default, { domain: domain, onStep: this.state.sectionIndex >= SectionIndex.BID_IT, actionText: actionText, action: this.handleStart })
        ),
        _react2.default.createElement(_ForProfessionals2.default, { id: 'about-us-for-professionals-section', className: 'about-us__for-professionals', onStep: this.state.sectionIndex >= SectionIndex.FOR_PROFESSIONALS, onClick: this.handleProStart }),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { id: 'tab3' },
            _react2.default.createElement(_TipsAndIdeas2.default, { className: 'about-us__tips-and-ideas' })
          )
        ),
        _react2.default.createElement(_Divider2.default, { className: 'about-us__divider' }),
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { id: 'tab4' },
            _react2.default.createElement(_PressAndMedia2.default, { className: 'about-us__press-and-media' })
          )
        )
      );
    }
