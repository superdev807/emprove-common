...
var _PressAndMedia = _interopRequireDefault(require("./components/PressAndMedia"));

var _TheTeam = _interopRequireDefault(require("./components/TheTeam"));

var _TipsAndIdeas = _interopRequireDefault(require("./components/TipsAndIdeas"));
...
function (_Component) {
  ...
  function AboutUs(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleProStart", function () {
  ...
  _createClass(AboutUs, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("main", {
        ...
        id: "tab3"
      }, _react.default.createElement(_TipsAndIdeas.default, {
        ...
        id: "tab4"
      }, _react.default.createElement(_PressAndMedia.default, {
