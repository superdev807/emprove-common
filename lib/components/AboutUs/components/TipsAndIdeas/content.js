...
function (_Component) {
  ...
  function TipsAndIdeas() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TipsAndIdeas).apply(this, arguments));
  }
...
_defineProperty(TipsAndIdeas, "propTypes", {
  ids: _propTypes["default"].object,
  imageSize: _propTypes["default"].string
});

_defineProperty(TipsAndIdeas, "defaultProps", {
  ids: {}
});

var _default = TipsAndIdeas;
