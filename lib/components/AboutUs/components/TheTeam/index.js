...
function (_React$Component) {
  ...
  function TheTeam(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleHomeAreaClick", function (dreamSpace) {
      return function () {
        _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleCatalogPhotoModalClose", function () {
      _this.setState({
