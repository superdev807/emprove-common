...
function (_React$Component) {
  ...
  function TeamMember(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePhotoMouseOver", function () {
      _this.setState({
        showOverlay: true
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePhotoMouseOut", function () {
      _this.setState({
        showOverlay: false
      });
    });
