...
function (_Component) {
  ...
  function AddressField(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AddressField).call(this, props));
  ...
  _createClass(AddressField, [{
    ...
    value: function componentDidMount() {
      ...
      if (!window.google) {
        this.cancelableLoadScript = (0, _promiseFunctions.makeCancelable)((0, _loadScript["default"])("https://maps.googleapis.com/maps/api/js?key=".concat(process.env.GEOCODE_MAP_API_KEY, "&libraries=places")));
