...
var HelpLinkButton = function HelpLinkButton(props) {
  return _react2.default.createElement(
    ...
    {
      className: (0, _classnames2.default)('help-link-button', {
      ...
      target: '_blank' },
    _react2.default.createElement(_HelpOutline2.default, { className: (0, _classnames2.default)({
        'help-link-button--size-16': props.size === 16,
        'help-link-button--size-32': props.size === 32
      }) })
  );
...
HelpLinkButton.propTypes = {
  ...
  margin: _propTypes2.default.oneOf(['left', 'right-16']),
  path: _propTypes2.default.string.isRequired,
  size: _propTypes2.default.oneOf([16, 32])
};
