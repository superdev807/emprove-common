...
var HelpLinkButton = function HelpLinkButton(props) {
  return _react2.default.createElement(
    ...
    {
      className: (0, _classnames2.default)('help-link-button', { 'help-link-button--size-16': props.size === 16, 'help-link-button--left-margin': props.margin === 'left' }, props.className),
      component: 'a',
