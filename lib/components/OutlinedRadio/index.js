...
var OutlinedRadio = _react["default"].forwardRef(function (props, ref) {
  var checked = props.checked,
      ...
      label = props.label,
      value = props.value,
      otherProps = _objectWithoutProperties(props, ["checked", "classes", "className", "disabled", "label", "value"]);
  ...
  return disabled ? _react["default"].createElement(ControlLabel, _extends({
    ...
    label: label,
    disabled: true
  }, otherProps)) : _react["default"].createElement(ControlLabel, _extends({
    value: value,
    className: className,
