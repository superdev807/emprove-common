  ...
  _createClass(CatalogPhotoModal, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _Modal2.default,
        { disableAutoFocus: true, open: this.props.open, onClose: this.props.onClose },
        _react2.default.createElement(
          'div',
          { className: (0, _classnames2.default)('catalog-photo-modal', {
          ...
          _react2.default.createElement(_CatalogPhoto2.default, {
            className: (0, _classnames2.default)('catalog-photo-modal__catalog-photo', { 'catalog-photo-modal__catalog-photo--loading': this.state.loading }),
            imageUrl: process.env.IMGIX_CATALOG_IMAGES_HOST + image.imageKey,
            alt: imageName,
            loading: this.state.loading
          }),
          this.state.loading ? _react2.default.createElement(_LoadingIndicator2.default, null) : _react2.default.createElement(_CatalogPhotoHeader2.default, {
          ...
          _react2.default.createElement(_DreamItLink2.default, { browseFilter: imageName.toLowerCase().replace(/ /g, '-'), disabled: this.state.loading, fromContractor: this.props.fromContractor }),
