...
function (_React$Component) {
  ...
  function CatalogPhotoModal(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleImageLoad", function () {
      _this.setState({
        loading: false
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleImageError", function () {
      _this.setState({
        loading: false,
