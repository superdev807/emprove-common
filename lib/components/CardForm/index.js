...
function (_Component) {
  ...
  _createClass(CardForm, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("form", {
      ...
      }, error), this.props.showCancelSaveButtons ? _react["default"].createElement("div", {
        className: "card-form__btns-container"
        ...
        className: "card-form__btn-action",
        variant: "contained",
        color: "primary",
        type: "submit"
...
_defineProperty(CardForm, "propTypes", {
  ...
  showCancelSaveButtons: _propTypes["default"].bool,
...
var _default = (0, _redux.compose)(_reactStripeElements.injectStripe, _styles.withTheme)(CardForm);
