...
var AddToCalendar = function (_Component) {
  ...
  _createClass(AddToCalendar, [{
    ...
    key: 'getGoogleCalendarLink',
    value: function getGoogleCalendarLink() {
      // [ ] convert ' ' to '+'
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Popper2.default,
          { className: (0, _classnames2.default)('add-to-calendar__popper', this.props.classes.popper), open: this.state.open, anchorEl: this.anchorEl, transition: true, disablePortal: this.props.disablePortal },
          function (_ref) {
            var TransitionProps = _ref.TransitionProps,
                placement = _ref.placement;
            return _react2.default.createElement(
              _Grow2.default,
              _extends({ id: 'add-to-calendar-menu-list-grow' }, TransitionProps, { style: { transformOrigin: placement === 'bottom' ? 'center top' : 'center bottom' } }),
              _react2.default.createElement(
                _Paper2.default,
                null,
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      _MenuItem2.default,
                      { className: 'add-to-calendar__menu-item', component: 'a', href: _this2.getGoogleCalendarLink(), target: '_blank', rel: 'noopener noreferrer' },
