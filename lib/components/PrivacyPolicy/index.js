...
var PrivacyPolicy = function PrivacyPolicy(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'privacy-policy-content__paragraph' },
      _react2.default.createElement(
        'span',
        null,
      ...
      '\u201D) describes the manner in which Emprove, Inc. (\u201C',
      _react2.default.createElement(
        'b',
        null,
        'Emprove'
      ...
      '\u201D) and our website at emproveit.com (the \u201CSite\u201D), as well as all related websites, networks, applications, and other services provided by us and on which a link to this Policy is displayed (collectively, together with the Site, our \u201C',
      _react2.default.createElement(
        'b',
        null,
        'Service'
      ),
      '\u201D) use and collect data from individuals. This Policy, which is incorporated into and is subject to the applicable Emprove Terms of Service, describes the information that we gather from you on the Service, how we use and disclose such information, and the steps we take to protect such information. ',
      _react2.default.createElement('br', null),
      _react2.default.createElement('br', null),
      _react2.default.createElement(
        'b',
      ...
      _react2.default.createElement(
        'ul',
        { className: 'privacy-policy-content__list' },
        _react2.default.createElement(
          'li',
          null,
          _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          ' We may display third-party content on the Service, including third-party advertising. Third-party content may use cookies, web beacons, or other mechanisms for obtaining data in connection with your viewing of the third party content on the Service. Additionally, we may implement third party buttons (such as Facebook \u201Clike\u201D or \u201Cshare\u201D buttons) that may function as web beacons even when you do not interact with the button. Information collected through third-party web beacons and buttons is collected directly by these third parties, not by Emprove. Information collected by a third party in this manner is subject to that third party\u2019s own data collection, use, and disclosure policies.',
          ' ',
          _react2.default.createElement('br', null)
        ),
        _react2.default.createElement('br', null),
      ...
      ' Except as described in this Policy, we will not disclose information about you that we collect on the Service to third parties without your consent. We may disclose information to third parties if you consent to us doing so, as well as in the following circumstances: ',
      _react2.default.createElement('br', null),
      _react2.default.createElement(
        'ul',
        { className: 'privacy-policy-content__list' },
        ...
        _react2.default.createElement(
          'li',
          null,
          'Any information that you submit to the Service may be disclosed to third parties in connection with project proposals, RFPs, quotes, and estimates and subsequent communications, including without limitation contractors and other service providers who are members of our network. ',
          _react2.default.createElement('br', null)
        ),
        _react2.default.createElement(
          'li',
      ...
      _react2.default.createElement('br', null),
      _react2.default.createElement('br', null),
      'You may, of course, decline to share certain information with us, in which case we may not be able to provide to you some of the features and functionality of the Service. You may update, correct, or delete your account information and preferences at any time by accessing your account preferences page on the Service. If you wish to access or amend any other personal information we hold about you, you may contact us at support@emproveit.com. Please note that while any changes you make will be reflected in active user databases within a reasonable period of time, we may retain all information you submit for backups, archiving, prevention of fraud and abuse, analytics, satisfaction of legal obligations, or where we otherwise reasonably believe that we have a legitimate reason to do so. ',
      _react2.default.createElement('br', null),
      _react2.default.createElement('br', null),
      'If you receive commercial email from us, you may unsubscribe at any time by following the instructions contained within the email. You may also opt out from receiving commercial email from us by sending your request to us by email at support@emproveit.com or by writing to us at the address given at the end of this policy. We may allow you to view and modify settings relating to the nature and frequency of promotional communications that you receive from us in user account functionality on the Service. ',
      _react2.default.createElement('br', null),
      _react2.default.createElement('br', null),
      ...
      _react2.default.createElement('br', null),
      _react2.default.createElement('br', null),
      'information about you will not be accessed, viewed, disclosed, altered, or destroyed by breach of any of our physical, technical, or managerial safeguards. ',
      _react2.default.createElement('br', null),
      'We use certain physical, managerial, and technical safeguards that are designed to improve the integrity and security of information that we collect and maintain. Please be aware that no security measures are perfect or impenetrable. We cannot and do not guarantee that ',
      _react2.default.createElement('br', null),
      _react2.default.createElement('br', null),
      _react2.default.createElement(
        'b',
      ...
      _react2.default.createElement('br', null),
      _react2.default.createElement('br', null),
      'Please contact us with any questions or comments about this Policy, information we have collected or otherwise obtained about you, our use and disclosure practices, or your consent choices by email at support@emproveit.com. ',
      _react2.default.createElement('br', null),
      _react2.default.createElement('br', null),
      'Emprove, Inc. ',
      _react2.default.createElement('br', null),
