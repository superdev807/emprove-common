...
var _AutoCompleteAddressField = _interopRequireDefault(require("../AutoCompleteAddressField"));
  ...
  _createClass(FlyerFormFields, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          handleSubmit = _this$props.flyerForm.handleSubmit,
      ...
      return _react["default"].createElement("form", {
        ...
        component: _AutoCompleteAddressField["default"],
        fullWidth: true,
        validate: [isRequired],
        className: classes.field,
        errorMessageClass: classes.error,
      ...
      }, "Save & Share")), _react["default"].createElement(_Grid["default"], {
        item: true
      }, _react["default"].createElement(_Button["default"], {
        type: "submit",
        variant: "contained",
...
var _default = (0, _redux.compose)((0, _reduxForm.reduxForm)({
  form: _constants.FORM.FLYER,
  enableReinitialize: true,
  propNamespace: _constants.FORM.FLYER
}), (0, _styles.withStyles)(_styles2["default"]))(FlyerFormFields);
