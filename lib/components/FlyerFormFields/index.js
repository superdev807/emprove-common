  ...
  _createClass(FlyerFormFields, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("form", {
        ...
        className: classes.label
      }, "Realtor:"), _react["default"].createElement(_reduxForm.Field, {
        name: "realtorId",
        ...
        className: classes.textLabel
      }, (0, _get["default"])(realtorDetails, 'email', '-'))))), _react["default"].createElement(_Grid["default"], {
        container: true,
        spacing: 16,
        ...
        className: classes.label
      }, "Home (sq. ft.):"), _react["default"].createElement(_reduxForm.Field, {
        name: "property.sqft",
        type: "text",
        component: _InputField["default"],
        fullWidth: true,
        ...
        className: classes.label
      }, "Area (sq. ft.):"), _react["default"].createElement(_reduxForm.Field, {
        name: "areaSqft",
        type: "text",
        component: _InputField["default"],
        fullWidth: true,
