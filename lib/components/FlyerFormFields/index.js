...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context6; _forEachInstanceProperty(_context6 = ownKeys(source, true)).call(_context6, function (key) { _defineProperty(target, key, source[key]); }); } else if (_Object$getOwnPropertyDescriptors) { _Object$defineProperties(target, _Object$getOwnPropertyDescriptors(source)); } else { var _context7; _forEachInstanceProperty(_context7 = ownKeys(source)).call(_context7, function (key) { _Object$defineProperty(target, key, _Object$getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var homeAreaOptions = _mapInstanceProperty(_context = metaData.homeAreas).call(_context, function (homeArea) {
  return {
    value: homeArea.id,
...
var scaleOptions = _mapInstanceProperty(_context2 = _sliceInstanceProperty(_context3 = metaData.projectScale).call(_context3, 0, 4)).call(_context2, function (scale) {
  return {
    value: scale.id,
...
var qualityOptions = _mapInstanceProperty(_context4 = metaData.qualityStandard).call(_context4, function (quality) {
  return {
    value: quality.id,
    label: quality.label
  };
  ...
  _createClass(FlyerFormFields, [{
    ...
    value: function render() {
      ...
      return React.createElement("form", {
        ...
        color: "primary"
      }, _concatInstanceProperty(_context5 = "".concat(city.label, ", ")).call(_context5, city.stateNameShort)))), React.createElement(Grid, {
        item: true,
        xs: 4
      }, React.createElement(Typography, {
        className: classes.label
