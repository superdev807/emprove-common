  ...
  _createClass(InformationButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        {
          className: (0, _classnames2.default)('information-button', { 'information-button--size-16': this.props.size === 16 }),
          onClick: this.handleClick
        },
        _react2.default.createElement(_InfoOutline2.default, {
          className: (0, _classnames2.default)({ 'information-button--size-16': this.props.size === 16 })
        })
      );
    }
  }]);
