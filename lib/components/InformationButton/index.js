...
var InformationButton = function (_Component) {
  ...
  _createClass(InformationButton, [{
    ...
    value: function render() {
      ...
      var Icon = icon === 'help' ? _HelpOutline2.default : _IconInfo2.default;

      return _react2.default.createElement(
        _IconButton2.default,
        {
          className: (0, _classnames2.default)('information-button', 'information-button--size-' + size, className),
          onClick: this.handleClick },
        _react2.default.createElement(Icon, { className: (0, _classnames2.default)('information-button--size-' + size, iconClass, { 'information-button--blink': blink }) }),
        tooltip
      );
    }
  }]);
