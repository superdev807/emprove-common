...
function (_Component) {
  ...
  function SliderField(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "debouncedHandleChange", function (event, value) {
  ...
  _createClass(SliderField, [{
    ...
    value: function renderSliderLabels() {
      ...
      return _react.default.createElement("div", {
        className: (0, _classnames.default)('slider-field__labels', classes.labelsClassName)
      }, options.map(function (item, index) {
        return _react.default.createElement("div", {
          key: item.id,
          className: (0, _classnames.default)('slider-field__label', classes.labelClassName),
          style: {
    ...
    value: function renderTickMarks() {
      ...
      return _react.default.createElement("div", {
        className: (0, _classnames.default)('slider-field__ticks', classes.ticksClassName)
      }, options.map(function (item, index) {
        return _react.default.createElement("div", {
          key: item.id,
          className: (0, _classnames.default)('slider-field__tick', classes.tickClassName, {
