  ...
  _createClass(SliderField, [{
    ...
    value: function renderSliderLabels() {
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)('slider-field__labels', classes.labels) },
        options.map(function (item, index) {
          return _react2.default.createElement(
            'div',
            { key: item.id, className: (0, _classnames2.default)('slider-field__label', classes.label), style: { left: index * labelPosition + '%' } },
            _react2.default.createElement(
              _Typography2.default,
              {
                ...
                className: (0, _classnames2.default)('slider-field__label-text', { 'slider-field__label-text--selected': value === item.id }, classes.labelText) },
              item.description
            )
          );
        })
    ...
    value: function renderTickMarks() {
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)('slider-field__ticks', classes.ticks) },
        options.map(function (item, index) {
          return _react2.default.createElement('div', {
            key: item.id,
            className: (0, _classnames2.default)('slider-field__tick', classes.tick, { 'slider-field__tick--passed': value > item.id }),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Slider2.default, _extends({}, input, {
