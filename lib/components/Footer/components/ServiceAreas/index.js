...
var renderServiceAreaColumns = function renderServiceAreaColumns(serviceAreas) {
  ...
  var serviceAreasFirstHalf = _sliceInstanceProperty(serviceAreas).call(serviceAreas, 0, middleIndex);

  var serviceAreasSecondHalf = _sliceInstanceProperty(serviceAreas).call(serviceAreas, middleIndex);
