...
var instructions = [_react2.default.createElement(
  ...
  { className: 'how-to-use-subtitle' },
  'GET IT DONE'
), 'Receive a comprehensive Project Plan', 'Get preliminary pricing from qualified contractors', 'Compare proposals to make a well informed selection', 'Create a General Contractor work agreement'];
