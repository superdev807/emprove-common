...
exports.default = exports.TimezoneField = void 0;
...
var suggestions = (0, _timeFunctions.getAllTimezones)().map(function (timezone) {
  return {
    value: timezone,
...
function (_Component) {
  ...
  function TimezoneField(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSuggestionsFetchRequested", function (_ref2) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSuggestionsClearRequested", function () {
      _this.setState({
        suggestions: []
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChange", function (event, _ref3) {
...
var _default = (0, _styles.withStyles)(_styles2.default)(TimezoneField);
