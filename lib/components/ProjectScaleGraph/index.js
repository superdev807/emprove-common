...
function (_Component) {
  ...
  _createClass(ProjectScaleGraph, [{
    ...
    value: function renderTooltip(xValue) {
      ...
      var tooltipX = cx + (xValue < 4 ? 50 : -tooltipWidth - 50);
      var tooltipY = this.state.margin.top + (this.state.grid.height - tooltipHeight) / 2;
      var cy = tooltipY + tooltipHeight * 0.7;
      var polygonPoints = xValue < 4 ? "".concat(cx + 25, ",").concat(cy, " ").concat(cx + 50, ",").concat(cy, " ").concat(cx + 50, ",").concat(cy - 15) : "".concat(cx - 25, ",").concat(cy, " ").concat(cx - 50, ",").concat(cy, " ").concat(cx - 50, ",").concat(cy - 15);
      var projectScale = '';
      var costValues = [];
    ...
    value: function render() {
      ...
      }, this.renderGrid(), this.props.showYAxis && this.renderYAxis(), this.props.showXAxis && this.renderXAxis(), this.renderPlots(), this.renderXLabels(), this.renderYLabels(), this.renderMark(), this.renderTooltips()) : _react["default"].createElement("div", null, "There are no data sets to make a plot"));
    }
  }]);
