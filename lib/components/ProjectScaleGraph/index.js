...
function (_Component) {
  ...
  _createClass(ProjectScaleGraph, [{
    ...
    value: function renderXLabels() {
      ...
      var lastIndex = this.props.dataSets[0].values.length - 1;
      return _react["default"].createElement("g", {
    ...
    value: function renderMark() {
      ...
      if (mark) {
        ...
        }, this.renderTooltip(_cx, cy), _react["default"].createElement("circle", {
          cx: _cx,
          cy: cy,
          r: "15",
          fill: markColor ? markColor : '#ff9e3c'
    ...
    key: "renderTooltip",
    value: function renderTooltip(cx, cy) {
      ...
      var tooltipX = cx + (mark.xValue < 4 ? 50 : -tooltipWidth - 50);
      var tooltipY = Math.max(cy - 240, 0);
      var polygonPoints = mark.xValue < 4 ? "".concat(cx + 25, ",").concat(cy, " ").concat(cx + 50, ",").concat(cy, " ").concat(cx + 50, ",").concat(cy - 15) : "".concat(cx - 25, ",").concat(cy, " ").concat(cx - 50, ",").concat(cy, " ").concat(cx - 50, ",").concat(cy - 15);
      var projectScale = '';
      var costValues = [];
      ...
      for (var i = 1; i < 6; i++) {
        ...
        var found = dataSet.values.find(function (item) {
          return item.xValue === mark.xValue;
        });
    ...
    value: function render() {
      ...
      }, this.renderGrid(), this.props.showYAxis && this.renderYAxis(), this.props.showXAxis && this.renderXAxis(), this.renderPlots(), this.renderXLabels(), this.renderYLabels(), this.renderMark()) : _react["default"].createElement("div", null, "There are no data sets to make a plot"));
    }
  }]);
