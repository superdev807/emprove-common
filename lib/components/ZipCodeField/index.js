...
function (_Component) {
  ...
  _createClass(ZipCodeField, [{
    ...
    value: function render() {
      ...
      , _extends({
        ref: this.labelRef
      }, inputLabelProps), label), helperText && _react.default.createElement(_FormHelperText.default, null, helperText), _react.default.createElement(InputComponent, _extends({}, input, {
      ...
      }, moreProps)), !hideErrorText && touched && error && _react.default.createElement(_FormHelperText.default, {
