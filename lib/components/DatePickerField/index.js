  ...
  function DatePickerField() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DatePickerField.__proto__ || Object.getPrototypeOf(DatePickerField)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (date) {
      var _this$props = _this.props,
          ...
          toggleDateWidget = _this$props.toggleDateWidget;
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Input2.default, _extends({}, inputProps, { type: 'text', placeholder: 'MM/DD/YYYY' }))
      );
  ...
  _createClass(DatePickerField, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          open = _props.open,
          closeDateWidget = _props.closeDateWidget,
          alignment = _props.alignment;


      var inputDate = input.value !== 'Invalid date' && input.value !== '' ? _moment2.default.isMoment(input.value) ? input.value.format('MM/DD/YYYY') : (0, _moment2.default)(input.value, 'YYYY-MM-DD').format('MM/DD/YYYY') : null;
      var datePickerAlignment = alignment || 'left';
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactDatetime2.default, {
          ...
          className: (0, _classnames2.default)(datePickerClassName, datePickerAlignment),
          value: inputDate,
