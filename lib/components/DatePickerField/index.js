...
function (_Component) {
  ...
  function DatePickerField() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleBlur", function (date) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleInputRef", function (ref) {
      var inputRef = _this.props.inputRef;
      inputRef && ref && inputRef(ref.inputElement);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderInput", function (props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleValidDatePast", function (current) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleValidDateFuture", function (current) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleValidDate", function (current) {
