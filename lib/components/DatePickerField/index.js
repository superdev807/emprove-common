...
var DatePickerField = function (_Component) {
  ...
  function DatePickerField() {
    ...
    }, _this.handleValidDatePast = function (current) {
      var _this$props4 = _this.props,
          disableDatePast = _this$props4.disableDatePast,
          timezone = _this$props4.timezone;

      if (disableDatePast) {
        var disableDate = _momentTimezone2.default.tz(disableDatePast, timezone).startOf('day');
        return current.isSameOrAfter(disableDate);
      } else {
        return true;
      }
    }, _this.handleValidDateFuture = function (current) {
      var _this$props5 = _this.props,
          disableDateFuture = _this$props5.disableDateFuture,
          timezone = _this$props5.timezone;

      if (disableDateFuture) {
        var disableDate = _momentTimezone2.default.tz(disableDateFuture, timezone).endOf('day');
        return current.isSameOrBefore(disableDate);
      } else {
        return true;
      }
    }, _this.handleValidDate = function (current) {
...
DatePickerField.propTypes = {
  ...
  disableDateFuture: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.object]),
