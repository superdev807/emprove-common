...
var DatePickerField = function (_Component) {
  ...
  _createClass(DatePickerField, [{
    ...
    value: function render() {
      ...
      var inputDate = input.value !== 'Invalid date' ? _moment2.default.isMoment(input.value) ? input.value.format('MM/DD/YYYY') : (0, _moment2.default)(input.value, 'YYYY-MM-DD').format('MM/DD/YYYY') : null;
