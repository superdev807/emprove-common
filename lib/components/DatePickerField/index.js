...
var DatePickerField = function (_Component) {
  ...
  _createClass(DatePickerField, [{
    ...
    value: function render() {
      ...
      var inputDate = input.value ? _moment2.default.isMoment(input.value) ? input.value.format('MM/DD/YYYY') : (0, _moment2.default)(input.value, 'YYYY-MM-DD').format('MM/DD/YYYY') : (0, _moment2.default)().format('MM/DD/YYYY');
...
DatePickerField.propTypes = {
  ...
  dateValidator: _propTypes2.default.func,
  fullWidth: _propTypes2.default.bool,
  hideErrorText: _propTypes2.default.bool,
  label: _propTypes2.default.string,
  meta: _propTypes2.default.object,
  disableDatePast: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.instanceOf(Date)]),
