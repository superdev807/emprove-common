...
var LoadingIndicator = function LoadingIndicator(_ref) {
  ...
  return _react["default"].createElement("div", {
    className: (0, _classnames["default"])(classes.refreshOverlay, (_cx = {}, _defineProperty(_cx, classes.fixedOverlay, fixed), _defineProperty(_cx, classes.positionStatic, positionStatic), _cx), className),
