...
var InformationImage = function InformationImage(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('img', { className: 'information-image__image', src: props.image.url, alt: 'Information Image' })
    )
  );
};
...
var InformationModal = function InformationModal(props) {
  var images = props.images.map(function (image) {
    var imageHeight = image.height && image.height < 400 ? image.height : 400;
