...
var InformationModal = function (_Component) {
  ...
  _createClass(InformationModal, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _Dialog2.default,
        { classes: { paper: 'information-modal' }, open: this.props.show, onClose: this.props.handleHide, disableEnforceFocus: true },
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.terms && this.props.terms.map(function (term) {
            return _react2.default.createElement(InformationDefinition, { key: term.id, term: term, boldName: _this4.props.boldTermNames });
          }),
          this.renderImages()
        )
      );
...
InformationModal.propTypes = {
  boldTermNames: _propTypes2.default.bool,
