...
function (_Component) {
  ...
  _createClass(PdfViewerModal, [{
    ...
    value: function render() {
      ...
      })) : pdfKind === _constants.VIEW_PDF_KIND.FULL_RFP || pdfKind === _constants.VIEW_PDF_KIND.RFP_SUMMARY ? _react["default"].createElement(_Button["default"], {
        id: "buttons_downloaded_rfp",
        className: classes.downloadButton,
        color: "primary",
        variant: "contained",
        onClick: this.handleSendPDF
      }, "DOWNLOAD") : null), showEditButton && _react["default"].createElement(_Button["default"], {
        variant: "outlined",
        color: "primary",
        className: classes.editButton,
        onClick: onEditClick
      }, "SIGN UP TO EDIT PLAN"), _react["default"].createElement(_IconButton["default"], {
...
_defineProperty(PdfViewerModal, "propTypes", {
  ...
  type: _propTypes["default"].oneOf(['bid', 'rfp', 'rfpSummary'])
});
...
var actions = {
  ...
  sendRfpSummaryPdf: _pdf.sendRfpSummaryPdf,
  setSnackbar: _globalStatus.setSnackbar
};

var _default = (0, _redux.compose)((0, _styles.withStyles)(_styles2["default"]), (0, _reactRedux.connect)(selector, actions))(PdfViewerModal);
