    ...
    value: function renderDropdownMenu() {
      ...
      var menuContent = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: (0, _classnames2.default)('drop-down-menu__items-container', (0, _get2.default)(className, 'itemsContainer')) },
          menuItems.map(function (item) {
            ...
            return _react2.default.createElement(_FormControlLabel2.default, {
              className: (0, _classnames2.default)('drop-down-menu__item', (0, _get2.default)(className, 'item')),
