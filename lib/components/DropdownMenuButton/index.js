      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { buttonRef: function buttonRef(node) {
            ...
            'aria-haspopup': 'true',
            className: (0, _classnames2.default)('drop-down-menu-btn__btn', { 'drop-down-menu-btn__btn--active': active }, className),
            variant: 'outlined' },
          _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Popper2.default,
          {
            ...
            className: (0, _classnames2.default)('drop-down-menu-btn__popper', popperClass) },
          _react2.default.createElement(
            _Paper2.default,
            { className: (0, _classnames2.default)('drop-down-menu-btn__paper', paperClass) },
