...
function (_Component) {
  ...
  function DropdownMenuButton(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleClickButton", function () {
      _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSelectMenuItem", function (value) {
      return function () {
  ...
  _createClass(DropdownMenuButton, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          highlightActive = _this$props2.highlightActive,
          ids = _this$props2.ids,
          menuItems = _this$props2.menuItems,
          onClearAll = _this$props2.onClearAll,
