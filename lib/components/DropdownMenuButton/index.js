...
var DropdownMenuButton = function (_Component) {
  ...
  _createClass(DropdownMenuButton, [{
    ...
    value: function render() {
      ...
      var id = open ? 'drop-down-menu-btn' : null;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { buttonRef: function buttonRef(node) {
            ...
            'aria-haspopup': 'true',
            className: (0, _classnames2.default)('drop-down-menu-btn__btn', { 'drop-down-menu-btn__btn--active': active }, (0, _get2.default)(className, 'button')),
            variant: 'outlined' },
          _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Popper2.default,
          {
            ...
            className: (0, _classnames2.default)('drop-down-menu-btn__popper', (0, _get2.default)(className, 'popper')) },
          _react2.default.createElement(
            _Paper2.default,
            { className: (0, _classnames2.default)('drop-down-menu-btn__paper', (0, _get2.default)(className, 'paper')) },
