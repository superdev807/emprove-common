  ...
  function DropdownMenuButton(props) {
    ...
    _this.handleSelectMenuItem = function (value) {
      return function () {
        ...
        var updatedSelectedItems = [].concat(_toConsumableArray(selectedItems));
        if (shouldSelectObject) {
          ...
          updatedSelectedItems = (0, _xor2.default)(selectedItems || [], [value]);
        }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            {
              className: (0, _classnames2.default)('drop-down-menu-btn__btn-label', { 'drop-down-menu-btn__btn-label--active': active }, classes.buttonLabel) },
            buttonLabel
          ),
