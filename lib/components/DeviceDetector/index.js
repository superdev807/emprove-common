...
function (_Component) {
  ...
  function DeviceDetector(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setDeviceType", function () {
    ...
    _this.setDeviceType = (0, _debounce.default)(_this.setDeviceType, 200, {
      trailing: true
    });
    return _this;
  }
...
DeviceDetector.propTypes = {
  detectDevice: _propTypes.default.func.isRequired
};

var _default = (0, _reactRedux.connect)(selector, action)(DeviceDetector);
