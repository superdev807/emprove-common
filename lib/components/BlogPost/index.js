...
function (_Component) {
  ...
  _createClass(BlogPost, [{
    ...
    value: function getURL() {
      ...
      if (post && post.URL) {
        if (fromContractor) {
          return url = "".concat(process.env.CONSUMER_DOMAIN, "/").concat(postType, "/").concat(post.ID, "/").concat(post.slug);
        }

        return url = "/".concat(postType, "/").concat(post.ID, "/").concat(post.slug);
      }
    }
  }, {
