...
var Logo = function Logo(_ref) {
  ...
  return _react2.default.createElement(
    ...
    {
      to: destination,
      className: (0, _classnames2.default)('logo', { 'logo__image--shortened': shortened, 'logo__image--beta': !shortened && isBeta }, className),
      id: id },
    _react2.default.createElement('img', { className: (0, _classnames2.default)('logo__image', imageClass), src: '/images/' + imageFilename, alt: 'Emprove | Home Improvement Renewed' })
  );
};
