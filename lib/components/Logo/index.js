...
var Logo = function Logo(_ref) {
  ...
  if (subDomain === _constants.PARTNER.REDFIN) {
    if (shortened) {
    ...
    imageFilename = "".concat(process.env.IMGIX_PUBLIC_IMAGES_HOST, "consumer/partner-landing/").concat(imageFilename, "?auto=format");
  } else {
