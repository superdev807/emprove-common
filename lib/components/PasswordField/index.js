  ...
  function PasswordField(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleBlur", function (event) {
      var _this$props = _this.props,
          ...
          placeholder = _this$props.placeholder; // if (placeholder) {
  ...
  _createClass(PasswordField, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", null, _react["default"].createElement(_FormControl["default"], {
        ...
        className: classes.popper // open={meterOpen && !(hasMinLengthChars && hasLetters && hasNumbers && hasSpecialChars)}
        ,
        open: true,
        transition: true,
        disablePortal: true
