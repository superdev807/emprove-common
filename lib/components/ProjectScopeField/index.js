        ...
        _react2.default.createElement(
          ...
          options.map(function (option, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'project-scope-field__option-box', onClick: _this2.handleChange(option.value) },
                _react2.default.createElement(
                  'div',
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    _Button2.default,
                    { className: 'project-scope-field__option-button', color: 'primary', fullWidth: true, variant: 'contained' },
                    'Select'
                  )
                )
              )
        ...
        _react2.default.createElement(
          ...
          chartOptions.map(function (option, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                _Typography2.default,
                { className: 'project-scope-field__text project-scope-field__text--chart', variant: 'body1' },
                option.label
              )
            );
          })
