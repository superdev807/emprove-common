...
var _ProjectScopeOptionBox = _interopRequireDefault(require("./components/ProjectScopeOptionBox"));

var _projectScopeOptions = _interopRequireDefault(require("./projectScopeOptions"));
  ...
  _createClass(ProjectScopeField, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        className: (0, _classnames["default"])('project-scope-field', _defineProperty({}, className, Boolean(className)))
      }, _react["default"].createElement(_Grid["default"], {
        container: true,
        spacing: 3
      }, _projectScopeOptions["default"].map(function (option, index) {
        return _react["default"].createElement(_Grid["default"], {
          key: index,
          item: true,
          className: "project-scope-field__option"
        }, _react["default"].createElement(_ProjectScopeOptionBox["default"], {
...
var _default = ProjectScopeField;
