  ...
  _createClass(ProjectScopeOptionBox, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { id: this.props.id, className: (0, _classnames2.default)('project-scope-option-box', this.props.className), onClick: this.props.onClick },
        _react2.default.createElement(
          'div',
          { className: 'project-scope-option-box__option-top' },
          _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'project-scope-option-box__option-bottom' },
          _react2.default.createElement(
            _Button2.default,
            { className: 'project-scope-option-box__option-button', color: 'primary', fullWidth: true, variant: 'contained' },
            'Select'
          )
        )
      );
