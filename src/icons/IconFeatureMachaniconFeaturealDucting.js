...
const IconFeatureMachaniconFeaturealDucting = props => {
  ...
  return (
    <SvgIcon x={0} y={0} viewBox="0 0 24 24" xmlSpace="preserve" {...props}>
      ...
      />
      <path fill={primary} d="M12.468 18.076H6.083l1.407.928h6.282z" />
    </SvgIcon>
  );
};

export default IconFeatureMachaniconFeaturealDucting;
