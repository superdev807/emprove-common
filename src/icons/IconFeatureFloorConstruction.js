...
const IconFeatureFloorConstruction = props => {
  ...
  return (
    <SvgIcon x={0} y={0} viewBox="0 0 24 24" xmlSpace="preserve" {...props}>
      ...
      />
      <circle fill={primary} cx={10.726} cy={16.57} r={0.67} />
      <circle fill={primary} cx={7.663} cy={6.591} r={0.67} />
      <circle fill={primary} cx={10.973} cy={6.591} r={0.67} />
      <circle fill={primary} cx={3.288} cy={17.216} r={0.67} />
      <circle fill={primary} cx={5.955} cy={17.216} r={0.67} />
    </SvgIcon>
  );
};

export default IconFeatureFloorConstruction;
