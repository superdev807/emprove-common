...
const IconFeatureDeviconFeatureesAndTrims = props => {
  ...
  return (
    <SvgIcon x={0} y={0} viewBox="0 0 24 24" xmlSpace="preserve" {...props}>
      ...
      />
      <path fill={primary} d="M7.727 7.654v-.937a.25.25 0 0 0-.5 0v.938a.25.25 0 1 0 .5-.001z" />
      <path
        fill={primary}
...
export default IconFeatureDeviconFeatureesAndTrims;
