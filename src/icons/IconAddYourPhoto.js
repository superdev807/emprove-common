...
const IconAddYourPhoto = props => (
  <SvgIcon viewBox="0 0 24 24" {...props}>
    ...
    <path d="M12 7.392c-3.142 0-5.698 2.556-5.698 5.697S8.858 18.787 12 18.787s5.697-2.557 5.697-5.698S15.142 7.392 12 7.392zm0 10.645a4.953 4.953 0 0 1-4.948-4.948A4.953 4.953 0 0 1 12 8.142a4.953 4.953 0 0 1 4.947 4.947A4.953 4.953 0 0 1 12 18.037z" />
    <path d="M12 9.896a3.194 3.194 0 1 0 0 6.388 3.194 3.194 0 0 0 0-6.388z" />
  </SvgIcon>
);
