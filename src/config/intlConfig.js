...
export default {
  ...
  messages: {
    ...
    'HOP.SUBSCRIBERS_LISTING_FULL_MODAL.CHOOSE_PRICING.TIP':
      "Check our SnapPrice image catalog where you can see estimates for others' images",
    'HOP.SUBSCRIBERS_LISTING_FULL_MODAL.CHOOSE_PRICING.ACTION_LABEL': 'Browse Ideas',
