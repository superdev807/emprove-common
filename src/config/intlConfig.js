...
export default {
  ...
  messages: {
    ...
    'HOP.BROWSE_MODAL.SNAPPRICE.REGISTRATION_PROMPT.CANCEL': 'No, show me my Project',
    'HOP.BROWSE_MODAL.SNAPPRICE.REGISTRATION_PROMPT.CONFIRM': "Yes, I'll sign up before seeing my Project",
    ...
    'HOP.INSTANT_ESTIMATE.CATALOG_LINK.TEXT': 'Or view our pre-designed SnapPrice plans',
    'HOP.INSTANT_ESTIMATE.MOBILE.ACTION_FOOTER.INFO.TEXT':
      'You can adjust the details to reflect your dream project while we help you stay on budget.',
    'HOP.INSTANT_ESTIMATE.MOBILE.ACTION_FOOTER.TITLE': 'BUILD YOUR DREAM <strong>{homeArea}</strong>',
    'HOP.LANDING.HERO.TEXT1': 'We turn inspiring images into your <br /><strong>affordable project plan</strong>',
    'HOP.LANDING.HERO.TEXT2': 'What room do you want to renovate?',
    'HOP.LANDING.HERO.ACTION_LABEL': 'GO',
    ...
    'HOP.LANDING.HOW_IT_WORKS.STEP2.BODY':
      'Our real-time, location-based pricing estimates provide the perfect mix of project materials and scope.',
    'HOP.LANDING.HOW_IT_WORKS.STEP3.TITLE': 'GET IT DONE',
    'HOP.LANDING.HOW_IT_WORKS.STEP3.BODY':
    ...
    'HOP.RFP.IN_MARKET_PAYWALL.HEADER':
      '<strong>STEP 1 - ACTIVATE YOUR PROJECT</strong><br />to get qualified contractors to complete for your business',
    ...
    'HOP.RFP.IN_MARKET_PAYWALL.ACTIVATION.BODY':
      'You pay ${amount} to purchase your plan and unlock the pricing process with qualified contractors. We will refund your money when you hire a contractor through Emprove.',
