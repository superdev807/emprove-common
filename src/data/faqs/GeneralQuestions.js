...
const HOW_MUCH_DOES_IT_COST_TO_USE_EMPROVE = {
  ...
  body: [
    '** _For Homeowners_ **',
    'Turn your inspiration image into a project cost estimate. Emprove delivers the [RFP](/info-center/definitions/pricing-brief) and administers the pricing process where we do all the leg work in obtaining multiple contractor quotes on your behalf.',
    '** _For Contractors_ **',
