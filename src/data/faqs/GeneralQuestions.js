  ...
  terms: [
    [
      ...
      },
      {
        ...
        title: '*For Homeowners:*',
        name:
          'Step 2 - *Cost It!* Get instant and comprehensive project cost estimates for your project that are uniquely tailored to your design preferences, budget parameters, and location.'
      },
      {
        id: 3,
        hasMarkdown: true,
        title: '*For Homeowners:*',
        name:
          'Step 3 - *Bid It!* Sit back while Emprove sends a detailed request-for-proposal (RFP) package to multiple qualified contractors. They submit their best price and you pick the one who presents you the best value.'
      },
      {
        id: 4,
        hasMarkdown: true,
    ...
    [
      {
        ...
        name:
          'Step 1 -Without having to pay any lead fees, contractors receive an invitation to submit a bid in response to an emailed RFP package for a real project that has been matched to their profile.'
      },
      {
        id: 2,
        hasMarkdown: true,
        title: '*For Contractors:*',
        name:
          'Step 2 - Upon accepting the invitation to bid, the contractor is provided access to the online bidding platform where they can review the full RFP package and efficiently submit their bid '
      },
      {
        id: 3,
        hasMarkdown: true,
        title: '*For Contractors:*',
        name:
          'Step 3 - Shortlisted contractors from the initial bid submission conduct a site visit with the homeowner to confirm bid assumptions and update their proposal if necessary.'
      },
      {
        id: 4,
        hasMarkdown: true,
...
const HOW_MUCH_DOES_IT_COST_TO_USE_EMPROVE = {
  ...
  body: [
    ...
    'Homeowners dream, scope, and estimate the cost of their projects at Emprove for free. Then for $20, Emprove delivers the [RFP](/info-center/definitions/request-for-proposal) and administers the bid process. Once a contractor is selected, Emprove fully refunds the $20 to homeowners. ',
    '** _For homeowners outside of Las Vegas_ **',
    'Homeowners dream, scope, and estimate the cost of their projects at Emprove for free. Then for $10, Emprove delivers the [RFP](/info-center/definitions/request-for-proposal) which the homeowner can use to administer a bid process. ',
    '** _For contractors_ **',
    'Contractors pay no lead fees and can submit unlimited bids for free. Contractors pay a project success fee only when they are awarded the job dependent on project cost:'
  ],
  terms: [
    {
      id: 1,
...
const GeneralQuestions = {
  DOES_EMPROVE_SELL_BUILDING_PRODUCTS_MATERIALS,
  DOES_EMPROVES_COST_ESTIMATES_INCLUDE_LABOR,
  DO_CONTRACTORS_WORK_FOR_EMPROVE,
  WILL_THE_CONTRACTOR_HAVE_AN_OPPORTUNITY_TO_CONDUCT_A_SITE_VISIT_OF_THE_PROJECT,
  HOW_MANY_CONTRACTORS_BID_EACH_PROJECT,
  WHAT_IS_THE_ORIGIN_OF_THE_PROJECT_COST_ESTIMATE,
  DOES_EMPROVE_HAVE_AN_APP,
  WHAT_TYPES_OF_HOME_IMPROVEMENT_SERVICES_CAN_YOU_GET_DONE_USING_EMPROVE,
  WHO_IS_THE_EMPROVE_LEADERSHIP_TEAM,
  HOW_DOES_EMPROVE_WORK,
  WHERE_IS_EMPROVE_BASED,
  WHAT_PROBLEMS_DOES_EMPROVE_SOLVE,
  WHEN_WAS_EMPROVE_FOUNDED,
  DOES_EMPROVE_HAVE_VC_FUNDING,
  I_DONT_LIVE_IN_LAS_VEGAS_CAN_I_STILL_USE_EMPROVE,
  WHAT_IS_EMPROVE,
  WILL_EMPROVE_EXPAND_BEYOND_THE_SOUTHWEST,
  HOW_ARE_YOU_DIFFERENT_FROM_YOUR_COMPETITORS,
  WHY_ARE_YOU_LAUNCHING_IN_LAS_VEGAS,
  WHAT_CITIESREGIONS_DOES_EMPROVE_SERVICE,
  MY_CONTRACTOR_DIDNT_FOLLOW_THROUGH_WITH_THE_PROJECT_AS_SCOPED_WHAT_SHOULD_I_DO,
  MY_CONTRACTOR_PROVIDED_ME_WITH_A_CONTRACT_IS_THAT_SUFFICIENT,
  HOW_DOES_EMPROVE_HANDLE_RATINGS_DISPUTES_FROM_CONTRACTORS,
  CAN_CONTRACTORS_REVIEW_HOME_OWNERS,
  CAN_HOMEOWNERS_REVIEW_CONTRACTORS,
  ARE_ALL_EMPROVE_CONTRACTORS_LICENSED,
  HOW_MUCH_DOES_IT_COST_TO_USE_EMPROVE
};
