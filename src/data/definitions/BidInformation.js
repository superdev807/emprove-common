...
const BID = {
  title: 'BID',
  body: ['A contractor offer of a price to provide requested services, as described by an RFP.'],
  terms: [],
  images: []
};
...
const BID_PROCESS = {
  title: 'BID PROCESS',
  body: [
    'An organized set of steps uniquely defined by Emprove with the objective to allow the homeowner to comprehensively convey the scope of their project, efficiently solicit competitive Bids from qualified contractors, and ultimately select their contractor with confidence and transparency.  The steps are generally as follows:'
  ],
  terms: [
    {
      id: 1,
    ...
    {
      id: 2,
      name: 'Homeowner creates a Styleboard for their project;',
      definition: null
    },
    {
      id: 3,
    ...
    {
      id: 4,
      name: "Emprove prepares a comprehensive RFP package for the homeowner's project;",
      definition: null
    },
    {
      id: 5,
