...
const CONTINGENCY = {
  ...
  body: [
    ...
    'In the case of a [Lump Sum Agreement](/info-center/definitions/lump-sum-agreement), contingency is generally not included in the contractor’s price, rather is held aside by the homeowner in addition to it.'
  ],
  terms: []
};
